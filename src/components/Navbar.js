...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="w-full h-max bg-gradient-to-r from-green-400 via-blue-500 to-red-500 shadow-lg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            {/* logo and brand */}
            <div className="flex items-center">
              <div className="flex-shrink-0">
                <span className="text-2xl font-bold text-white bg-opacity-20 bg-orange px-3 py-1 rounded-lg">
                  AO
                </span>
              </div>
