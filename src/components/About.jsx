      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="text-center space-y-8 mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            I am a first-year B.Tech student 👨🏻‍💼in ECE, with a strong passion for
            coding and software development👨🏻‍💻. Currently learning languages such
            as HTML, CSS, and Java Script. I have also completed some languages
            during my schooling such as Python and SQL. I am eager to enhance my
            coding skills, work on real-world projects, and contribute to
            innovative solutions in the tech industry. Looking for opportunities
            to grow, collaborate, and develop as a software developer✨
          </p>
        </div>
        ...
        <div className="bg-white p-8 rounded-xl shadow-lg mb-16">
          ...
          <div className="space-y-6 text-left max-w-4xl mx-auto">
            <p className="text-lg text-gray-600">
              I started my journey at my school back in 2023, working with my
              friends and teacher. Then i got engulfed in the field of coding ,
              specially web development
            </p>
            <p className="text-lg text-gray-600">
              Currently, I'm focused on learning more of the languages. I'm
        ...
        <div className="bg-white p-8 rounded-xl shadow-lg mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left max-w-4xl mx-auto">
            <div className="space-y-3">
              ...
              <p className="text-lg text-gray-600">
                Active contributor to various projects in my society.
              </p>
            </div>
            <div className="space-y-3">
